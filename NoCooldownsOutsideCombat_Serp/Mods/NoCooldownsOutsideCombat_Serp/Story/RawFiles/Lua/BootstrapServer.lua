...
RegisterProtectedOsirisListener("SkillCast", 4, "after", function(charGUID, skill, skilltype, skillelement)
  if Osi.ObjectIsCharacter(charGUID)==1 and Osi.CharacterIsInCombat(charGUID)==0 and Osi.CharacterHasSkill(charGUID,skill)==1 then -- [in](GUIDSTRING)_Object, [out](INTEGER)_Bool 

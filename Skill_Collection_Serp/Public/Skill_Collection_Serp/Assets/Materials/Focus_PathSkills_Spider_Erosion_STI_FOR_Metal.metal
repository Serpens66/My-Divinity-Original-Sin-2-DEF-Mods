...
vertex VertexOutput Materials_Focus_PathSkills_Spider_Erosion_STI_FOR_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput Materials_Focus_PathSkills_Spider_Erosion_STI_FOR_Metal_fragmentMain(constant LocalUniformsPS& uniforms,

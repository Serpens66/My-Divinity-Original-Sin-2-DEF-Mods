...
vertex VertexOutput Materials_Focus_PathSkills_Materials_Eggs_Clean_ST_SHA_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Materials_Focus_PathSkills_Materials_Eggs_Clean_ST_SHA_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
	constant EoCGlobalConstantData& eocGlobal,

...
vertex VertexOutput Materials_Focus_PathSkills_Egg_Erosion_SK_DEF_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Materials_Focus_PathSkills_Egg_Erosion_SK_DEF_Metal_fragmentMain(constant LocalUniformsPS& uniforms,

...
vertex VertexOutput Materials_Focus_PathSkills_Egg_Clean_ST_DEP_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Materials_Focus_PathSkills_Egg_Clean_ST_DEP_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
	constant EoCGlobalConstantData& eocGlobal,

...
vertex VertexOutput Materials_Focus_PathSkills_Materials_Eggs_Emissive_STI_SHA_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Materials_Focus_PathSkills_Materials_Eggs_Emissive_STI_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;

...
vertex VertexOutput Materials_Focus_PathSkills_Plant_Clean_STI_SHA_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput Materials_Focus_PathSkills_Plant_Clean_STI_SHA_Metal_fragmentMain(constant LocalUniformsPS& uniforms,

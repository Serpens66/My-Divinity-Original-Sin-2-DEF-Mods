...
vertex VertexOutput Characters_PBR_Characters_PBR_Base_Pulsing_Ooze_STI_SHA_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput Characters_PBR_Characters_PBR_Base_Pulsing_Ooze_STI_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;
